...
export class PlannerComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.fg = new FormGroup({
      ...
      startDate: new FormControl(formatDate(new Date(), 'yyyy-MM-dd', 'en', null)),
      endDate: new FormControl(formatDate(new Date(), 'yyyy-MM-dd', 'en', null)),
      devId: new FormControl(null, { validators: [Validators.required] }),
